...
#fil="C:\Users\Koribilli Eakshitha\Desktop\attachments\food.png"
#background_img = ImageTk.PhotoImage(Image.open(fil))
background_img = PhotoImage(file="C:\Python27\mppl\recipe\food1.png")
